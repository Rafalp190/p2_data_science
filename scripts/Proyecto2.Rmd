...
Ahora que hemos unido ambos Cards, eliminado outliers y desechado variables innecesari, nuestro conjunto de datos está listo para entrar a un analisis de Clustering.
...
En el peso podemos ver el mismo comportamiento analizado anteriormente. Pero a diferencia de la edad y la altura, pareciera que el peso varía de forma distinta dentro de cada grupos.
...
En el pliegue subescapular pareciera que siguen el patron encontrado anteriormete. Pero el primer grupo y el cuarto son muy similares, aunque la media del primer grupo está por arriba de la media del cuarto. Sera esto debido a la cantidad de hombres y mujeres dentro del grupo?
...
En el grupo 2 estan las personas mas juvenes, se puede ver como cambia drasticamente la altura en los niños y se empieza a estabilizar a los 10 años.
...
En el grupo 3 se puede observar como las personas estan entrando a la adolescencia y empiezan a tener cambios drasticos en la altura entre los 11 y 14 años.
...
En el grupo 1, el de los jovenes, se ve que obtienen mas fuerza entre mas crecen, pero la fuerza deja de aumentar considerablemente despues de los 15 años, esto puede ser debido a la alta cantidad de mujeres, suponiendo que las mujeres tienen menos fuerza en las manos que los hombres.
...
En el grupo 3 se ve como las personas van obteniendo mas fuerza conforme crecen y dejan de ser niños
...
En el grupo 2 se ve como los niños aumentan de peso gradualmente durante su crecimiento. Aqui se encuentran las personas menos pesadas.
...
En el grupo 3 puede verse que estan las personas mas pesadas de 5, 6 y 7 años, edades que tambien estan presente en el grupo 2. Luego se puede apreciar como las personas siguen aumentando de peso conforme van creciendo.
...
En el grupo 4 estan las personas mas pesadas de todas. desde niños hasta adultos.

## Conclusion de Cluster

* La edad es una medida critica para entrar o no a los grupos.
* Si eres un niño con peso y altura de un joven, el clustering te agrupará a ellos y viceversa.
